...
<html>
    ...
    <body class="w3-light-grey" style="background-color: seashell ">
                    ...
                    <form action="" method="POST">  <!--go to search controller-->
                        <div class="w3-row-padding" style="margin:0 -16px;">
                            <div class="w3-half w3-margin-bottom">
                                ...
                                <input class="w3-input w3-border" type="text" placeholder="Ex. Kinh Van Hoa" id="title">
                            </div>
                            <div class="w3-half">
                                <label><i class="fa fa-male"></i> Author</label>
                                <input class="w3-input w3-border" type="text" placeholder="Ex. Anh Nguyen Nhat" id="author">
                            </div>
                        </div>
                        <div class="w3-row-padding" style="margin:8px -16px;">
                            ...
                            <div class="w3-quarter">
                                ...
                                <input class="w3-input w3-border" type="text" id="publisher" placeholder="Ex. Kim Dong">
                            </div>
                            <div class="w3-quarter">
                    ...
                    <c:forEach items="${requestScope.books}" var="book">
                        <div class="w3-container w3-white">
                            <div class="w3-quarter w3-margin">
                                ...
                                <img src="/BookManagement/images/${book.image}" class="w3-image" style="height: 300px; margin-left: 10%; margin-bottom: 10px">
